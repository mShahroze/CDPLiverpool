<?php get_header(); ?>
				<div class="qodef-page-not-found">
					<?php
					$qodef_title_image_404 = brunn_select_options()->getOptionValue( '404_page_title_image' );
					...
					if ( ! empty( $qodef_title_image_404 ) ) { ?>
						<div class="qodef-404-title-image">
							<img src="<?php echo esc_url( $qodef_title_image_404 ); ?>" alt="<?php esc_attr_e( '404 Title Image', 'brunn' ); ?>" />
						</div>
					<?php } ?>
					...
					<h3 class="qodef-404-subtitle">
						<?php if ( ! empty( $qodef_subtitle_404 ) ) {
							...
							esc_html_e( 'Page not found', 'brunn' );
						} ?>
					</h3>
					...
					<p class="qodef-404-text">
						<?php if ( ! empty( $qodef_text_404 ) ) {
							...
							esc_html_e( 'Oops! The page you are looking for does not exist. It might have been moved or deleted.', 'brunn' );
						} ?>
					</p>
