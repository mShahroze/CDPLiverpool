...
if ( ! function_exists( 'brunn_select_add_dripicons_icon_pack' ) ) {
	function brunn_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new BrunnSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_dripicons_icon_pack_option' ) ) {
	function brunn_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_dripicons_icon_pack_option' );
}

class BrunnSelectClassDripicons implements iBrunnSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
