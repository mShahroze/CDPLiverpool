...
if ( ! function_exists( 'brunn_select_add_font_awesome_icon_pack' ) ) {
	function brunn_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new BrunnSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_font_awesome_icon_pack_option' ) ) {
	function brunn_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_font_awesome_icon_pack_option' );
	add_filter( 'brunn_select_filter_add_icon_pack_into_social_options', 'brunn_select_add_font_awesome_icon_pack_option' );
}

class BrunnSelectClassIconsFontAwesome implements iBrunnSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
