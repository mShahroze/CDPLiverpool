...
if ( ! function_exists( 'brunn_select_add_linea_icon_pack' ) ) {
	function brunn_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new BrunnSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_linea_icon_pack_option' ) ) {
	function brunn_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_linea_icon_pack_option' );
}

class BrunnSelectClassLineaIcons implements iBrunnSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
