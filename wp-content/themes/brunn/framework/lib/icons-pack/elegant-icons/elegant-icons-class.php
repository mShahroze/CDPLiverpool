...
if ( ! function_exists( 'brunn_select_add_font_elegant_icon_pack' ) ) {
	function brunn_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new BrunnSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_font_elegant_icon_pack_option' ) ) {
	function brunn_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_font_elegant_icon_pack_option' );
	add_filter( 'brunn_select_filter_add_icon_pack_into_social_options', 'brunn_select_add_font_elegant_icon_pack_option' );
}

class BrunnSelectClassIconsFontElegant implements iBrunnSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function getMenuIcon() {
		...
		return $this->render('icon_grid-3x3');
	}
