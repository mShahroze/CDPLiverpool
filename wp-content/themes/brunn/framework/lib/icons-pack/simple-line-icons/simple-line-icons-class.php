...
if ( ! function_exists( 'brunn_select_add_simple_line_icon_pack' ) ) {
	function brunn_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new BrunnSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_simple_line_icon_pack_option' ) ) {
	function brunn_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_simple_line_icon_pack_option' );
	add_filter( 'brunn_select_filter_add_icon_pack_into_social_options', 'brunn_select_add_simple_line_icon_pack_option' );
}

class BrunnSelectClassSimpleLineIcons implements iBrunnSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'brunn'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'brunn'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'brunn'),
            'icon-social-facebook'    => esc_html__('Facebook', 'brunn'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'brunn'),
            'icon-social-github'      => esc_html__('Github', 'brunn'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'brunn'),
            'icon-social-instagram'   => esc_html__('Instagram', 'brunn'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'brunn'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'brunn'),
            'icon-social-reddit'      => esc_html__('Reddit', 'brunn'),
            'icon-social-skype'       => esc_html__('Skype', 'brunn'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'brunn'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'brunn'),
            'icon-social-spotify'     => esc_html__('Spotify', 'brunn'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'brunn'),
            'icon-social-twitter'     => esc_html__('Twitter', 'brunn'),
            'icon-social-youtube'     => esc_html__('Youtube', 'brunn')
        );
    }
