...
if ( ! function_exists( 'brunn_select_add_ion_icon_pack' ) ) {
	function brunn_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new BrunnSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_ion_icon_pack_option' ) ) {
	function brunn_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_ion_icon_pack_option' );
	add_filter( 'brunn_select_filter_add_icon_pack_into_social_options', 'brunn_select_add_ion_icon_pack_option' );
}

class BrunnSelectClassIonIcons implements iBrunnSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
