...
if ( ! function_exists( 'brunn_select_add_linear_icon_pack' ) ) {
	function brunn_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new BrunnSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_collection', 'brunn_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'brunn_select_add_linear_icon_pack_option' ) ) {
	function brunn_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'brunn' );
		
		return $options;
	}
	
	add_filter( 'brunn_select_filter_add_icon_pack_into_options', 'brunn_select_add_linear_icon_pack_option' );
}

class BrunnSelectClassLinearIcons implements iBrunnSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
