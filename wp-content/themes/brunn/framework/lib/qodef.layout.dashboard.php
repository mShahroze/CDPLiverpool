...
/*
   Class: BrunnSelectClassDashboardForm
   A class that initializes Select Dashboard Container
*/

class BrunnSelectClassDashboardForm implements iBrunnSelectInterfaceLayoutNode, iBrunnSelectInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: BrunnSelectClassDashboardGroup
   A class that initializes BrunnSelectClass Group Field
*/

class BrunnSelectClassDashboardGroup implements iBrunnSelectInterfaceLayoutNode, iBrunnSelectInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: BrunnSelectClassDashboardTitle
   A class that initializes Dashboard Title
*/

class BrunnSelectClassDashboardTitle implements iBrunnSelectInterfaceRender {
	private $name;
	private $title;
	private $args = array();
...
/*
   Class: BrunnSelectClassDashboardField
   A class that initializes BrunnSelectClass Front Field
*/

class BrunnSelectClassDashboardField implements iBrunnSelectInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class BrunnSelectClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class BrunnSelectClassDashboardFieldText extends BrunnSelectClassDashboardFieldType {
...
class BrunnSelectClassDashboardFieldTextArea extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class BrunnSelectClassDashboardFieldImage extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
            ...
            <div class="qodef-dashboard-gallery-holder">
                <ul class="qodef-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						print brunn_select_get_module_part( $value_html );
					} ?>
                </ul>
                <div class="qodef-dashboard-gallery-uploader">
					<?php
					if ( brunn_membership_theme_installed() ) {
						echo brunn_select_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'brunn' ),
							'custom_class' => 'qodef-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="qodef-btn qodef-btn-medium qodef-btn-solid qodef-dashboard-gallery-upload"><span class="qodef-btn-text">' . esc_html__( 'Upload', 'brunn' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
                        <button class="qodef-btn qodef-btn-solid qodef-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'brunn' ); ?></button>
					<?php } ?>
                </div>
            </div>
        </div>
...
class BrunnSelectClassDashboardFieldGallery extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class BrunnSelectClassDashboardFieldSelect extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class BrunnSelectClassDashboardFieldDate extends BrunnSelectClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class BrunnSelectClassDashboardFieldIcon extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
...
class BrunnSelectClassDashboardFieldColor extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class BrunnSelectClassDashboardFieldCheckBoxGroup extends BrunnSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class BrunnSelectClassDashboardFieldAddress extends BrunnSelectClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class BrunnSelectClassDashboardRepeater implements iBrunnSelectInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
                <div class="qodef-dashboard-repeater-table-heading">
                    <div class="qodef-dashboard-repeater-fields-holder">
                        <div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'brunn' ) ?></div>
                        ...
                        <div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'brunn' ) ?></div>
                    </div>
                </div>
			<?php } ?>
...
class BrunnSelectClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new BrunnSelectClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new BrunnSelectClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new BrunnSelectClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'image':
				$field = new BrunnSelectClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new BrunnSelectClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'select':
				$field = new BrunnSelectClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'icon':
				$field = new BrunnSelectClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'color':
				$field = new BrunnSelectClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new BrunnSelectClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new BrunnSelectClassDashboardFieldAddress();
