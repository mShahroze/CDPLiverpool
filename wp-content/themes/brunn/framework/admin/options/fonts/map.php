...
if ( ! function_exists( 'brunn_select_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function brunn_select_fonts_options_map() {
		
		brunn_select_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'brunn' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = brunn_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'brunn' )
			)
		);
		
		//H1
		$group_heading_h1 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'brunn' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'brunn' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h1_2 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h1_3 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'brunn' ),
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'brunn' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'brunn' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'brunn' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h2_2 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h2_3 = brunn_select_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'brunn' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'brunn' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h3_2 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h3_3 = brunn_select_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'brunn' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'brunn' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h4_2 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h4_3 = brunn_select_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'brunn' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'brunn' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h5_2 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h5_3 = brunn_select_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'brunn' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'brunn' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h6_2 = brunn_select_add_admin_row(
			array(
		...
		$row_heading_h6_3 = brunn_select_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = brunn_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'brunn' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'brunn' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = brunn_select_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'brunn' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = brunn_select_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'brunn' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = brunn_select_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'brunn' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = brunn_select_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'brunn' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = brunn_select_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'brunn' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = brunn_select_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = brunn_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'brunn' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = brunn_select_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = brunn_select_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = brunn_select_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = brunn_select_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = brunn_select_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = brunn_select_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = brunn_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'brunn' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = brunn_select_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = brunn_select_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = brunn_select_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = brunn_select_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = brunn_select_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = brunn_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = brunn_select_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = brunn_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = brunn_select_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'brunn' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'brunn' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'brunn' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = brunn_select_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'brunn' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'brunn' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = brunn_select_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'brunn' ),
				'description' => esc_html__( 'Define styles for link text', 'brunn' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'brunn' ),
				'parent'        => $row_link_1
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'brunn' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = brunn_select_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'brunn' ),
				'options'       => brunn_select_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'brunn' ),
				'options'       => brunn_select_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'brunn_select_action_options_map', 'brunn_select_fonts_options_map', brunn_select_set_options_map_position( 'fonts' ) );
}