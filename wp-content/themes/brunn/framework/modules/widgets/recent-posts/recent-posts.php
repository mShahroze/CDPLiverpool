...
if ( class_exists( 'BrunnSelectClassWidget' ) ) {
	class BrunnSelectClassRecentPosts extends BrunnSelectClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_recent_posts',
				esc_html__( 'Brunn Recent Posts', 'brunn' ),
				array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'brunn' ) )
			);
		...
		public function widget( $args, $instance ) {
			...
			$html = '<div class="widget qodef-recent-post-widget" ' . brunn_select_get_inline_style( $widget_styles ) . '>';
			...
			if ( $query->have_posts() ) {
				...
				$html .= esc_html__( 'Sorry, there are no posts matching your criteria', 'brunn' );
			}
