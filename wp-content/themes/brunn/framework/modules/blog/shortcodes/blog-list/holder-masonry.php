<div class="qodef-blog-list-holder qodef-grid-list qodef-grid-masonry-list qodef-disable-bottom-space <?php echo esc_attr( $holder_classes ); ?>" <?php echo wp_kses( $holder_data, array( 'data' ) ); ?>>
		...
		<ul class="qodef-blog-list qodef-masonry-list-wrapper">
			...
			if ( $query_result->have_posts() ):
				while ( $query_result->have_posts() ) : $query_result->the_post();
					brunn_select_get_module_template_part( 'shortcodes/blog-list/layout-collections/post-masonry', 'blog', $type, $params );
				endwhile;
			else:
	...
	<?php brunn_select_get_module_template_part( 'templates/parts/pagination/' . $params['pagination_type'], 'blog', '', $params ); ?>
</div>