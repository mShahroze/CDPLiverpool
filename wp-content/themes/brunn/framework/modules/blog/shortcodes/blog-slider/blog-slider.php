<?php
namespace BrunnCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'brunn' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'brunn' )            => 'slider',
							esc_html__( 'Carousel', 'brunn' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'brunn' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
