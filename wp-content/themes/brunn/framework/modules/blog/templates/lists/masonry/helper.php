...
if ( ! function_exists( 'brunn_select_get_blog_holder_params' ) ) {
	...
	function brunn_select_get_blog_holder_params( $params ) {
		...
		$masonry_layout = brunn_select_get_meta_field_intersect( 'blog_masonry_layout' );
...
if ( ! function_exists( 'brunn_select_get_blog_list_classes' ) ) {
	/**
	 * Function that generates blog list holder classes for blog list templates
	 */
	function brunn_select_get_blog_list_classes( $classes ) {
		$list_classes   = array();
		$list_classes[] = 'qodef-grid-list qodef-grid-masonry-list';
		
		$number_of_columns = brunn_select_get_meta_field_intersect( 'blog_masonry_number_of_columns' );
		if ( ! empty( $number_of_columns ) ) {
			$list_classes[] = 'qodef-' . $number_of_columns . '-columns';
		}
		
		$space_between_items = brunn_select_get_meta_field_intersect( 'blog_masonry_space_between_items' );
	...
	add_filter( 'brunn_select_filter_blog_list_classes', 'brunn_select_get_blog_list_classes' );
}
