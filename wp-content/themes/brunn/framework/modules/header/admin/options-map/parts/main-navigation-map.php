...
if ( ! function_exists( 'brunn_select_get_hide_dep_for_header_main_menu_options' ) ) {
	function brunn_select_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'brunn_select_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'brunn_select_header_main_navigation_options_map' ) ) {
	function brunn_select_header_main_navigation_options_map() {
		$hide_dep_options = brunn_select_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = brunn_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'brunn' ),
		...
		brunn_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'brunn' )
			)
		);
		
		$drop_down_group = brunn_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'brunn' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'brunn' )
			)
		);
		
		$drop_down_row1 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'brunn' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'brunn' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'brunn' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'brunn' )
				)
			)
		);
		...
		$first_level_group = brunn_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'brunn' )
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'brunn' ),
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'brunn' ),
			)
		);
		
		$first_level_row4 = brunn_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'brunn' ),
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'brunn' ),
			)
		);
		
		$first_level_row5 = brunn_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = brunn_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = brunn_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = brunn_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'brunn' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'brunn' )
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'brunn' )
			)
		);
		...
		$second_level_wide_group = brunn_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'brunn' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'brunn' )
			)
		);
		
		$second_level_wide_row1 = brunn_select_add_admin_row(
			array(
		...
		$second_level_wide_row2 = brunn_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = brunn_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = brunn_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'brunn' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'brunn' )
			)
		);
		...
		$third_level_wide_group = brunn_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'brunn' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'brunn' )
			)
		);
		
		$third_level_wide_row1 = brunn_select_add_admin_row(
			array(
		...
		$third_level_wide_row2 = brunn_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = brunn_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'brunn_select_action_header_main_navigation_options_map', 'brunn_select_header_main_navigation_options_map', 10, 1 );
}