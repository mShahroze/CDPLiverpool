<?php do_action('brunn_select_action_before_sticky_header'); ?>
...
<div class="qodef-sticky-header">
                ...
                <div class="qodef-position-left"><!--
                 --><div class="qodef-position-left-inner">
                        ...
                        <?php if($menu_area_position === 'left') : ?>
                            <?php brunn_select_get_sticky_menu('qodef-sticky-nav'); ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="qodef-position-right"><!--
                 --><div class="qodef-position-right-inner">
                        <?php if($menu_area_position === 'right') : ?>
                            <?php brunn_select_get_sticky_menu('qodef-sticky-nav'); ?>
                        <?php endif; ?>
                        <?php brunn_select_get_sticky_header_widget_menu_area(); ?>
                    </div>
                </div>
            </div>
            <?php if($sticky_header_in_grid) : ?>
	...
	<?php do_action( 'brunn_select_action_before_sticky_menu_html_close' ); ?>
</div>
