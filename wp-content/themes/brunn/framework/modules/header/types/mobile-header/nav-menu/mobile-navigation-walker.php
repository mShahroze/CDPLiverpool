...
if (!class_exists('BrunnSelectClassMobileNavigationWalker')) {
	class BrunnSelectClassMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="qodef-sub-arrow arrow_right"></i><i class="arrow_down"></i></span>';
				}
			}
