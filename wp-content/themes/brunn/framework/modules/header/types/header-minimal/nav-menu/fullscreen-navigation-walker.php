...
if (!class_exists('BrunnSelectClassFullscreenNavigationWalker')) {
	class BrunnSelectClassFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<i class="qodef-fullscreen-menu-arrow arrow_right"></i>';
				}
				$item_output .= '</a>';
			}
