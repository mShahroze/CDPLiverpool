...
if ( ! function_exists('brunn_select_contact_form_7_options_map') ) {

	function brunn_select_contact_form_7_options_map() {
		
		brunn_select_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'brunn' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = brunn_select_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'brunn' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = brunn_select_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'brunn' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'brunn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'brunn' ),
		));
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'brunn' ),
			)
		);
		...
		$typography_text_row2 = brunn_select_add_admin_row(
			array(
		...
		$typography_text_row3 = brunn_select_add_admin_row(
			array(
		...
		$typography_label_group = brunn_select_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'brunn' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'brunn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = brunn_select_add_admin_row(
			array(
		...
		$typography_label_row2 = brunn_select_add_admin_row(
			array(
		...
		$background_border_group = brunn_select_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'brunn' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'brunn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'brunn' )
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'brunn' )
			)
		);
		
		$background_border_row2 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'brunn' ),
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'brunn' )
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'brunn' )
			)
		);
		
		$background_border_row3 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = brunn_select_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'brunn' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = brunn_select_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = brunn_select_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'brunn' ),
				'description' => esc_html__( 'Setup form elements margin', 'brunn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = brunn_select_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'brunn' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'brunn' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'brunn' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = brunn_select_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'brunn' ),
				'description' => esc_html__( 'Setup button text typography', 'brunn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = brunn_select_add_admin_row(
			array(
		...
		$button_typography_row2 = brunn_select_add_admin_row(
			array(
		...
		$button_background_border_group = brunn_select_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'brunn' ),
				'description' => esc_html__( 'Setup button background and border style', 'brunn' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'brunn' )
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'brunn' )
			)
		);
		
		$button_background_border_row2 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'brunn' )
			)
		);
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'brunn' )
			)
		);
		
		$button_background_border_row3 = brunn_select_add_admin_row(
			array(
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'brunn' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		brunn_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'brunn' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = brunn_select_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'brunn')
		));

		//Text Typography

		$typography_text_group = brunn_select_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'brunn'),
			'description'	=> esc_html__('Setup typography for form elements text', 'brunn'),
		...
		$typography_text_row1 = brunn_select_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = brunn_select_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = brunn_select_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = brunn_select_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'brunn'),
			'description'	=> esc_html__('Setup typography for form elements label', 'brunn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = brunn_select_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = brunn_select_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = brunn_select_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'brunn'),
			'description'	=> esc_html__('Setup form elements background and border style', 'brunn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = brunn_select_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = brunn_select_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = brunn_select_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = brunn_select_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'brunn'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = brunn_select_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = brunn_select_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'brunn'),
			'description'	=> esc_html__('Setup form elements margin', 'brunn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = brunn_select_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = brunn_select_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'brunn'),
			'description'	=> esc_html__('Setup button text typography', 'brunn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = brunn_select_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = brunn_select_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = brunn_select_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'brunn'),
			'description'	=> esc_html__('Setup button background and border style', 'brunn'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = brunn_select_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = brunn_select_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = brunn_select_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = brunn_select_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'brunn')
        ));
        ...
        $typography_label_row3 = brunn_select_add_admin_row(array(
        ...
        $button_typography_row3 = brunn_select_add_admin_row(array(
	...
	add_action( 'brunn_select_action_options_map', 'brunn_select_contact_form_7_options_map', brunn_select_set_options_map_position( 'contact_form_7' ) );
}