<?php
$qodef_search_holder_params = brunn_select_get_holder_params_search();
?>
<?php get_header(); ?>
<?php brunn_select_get_title(); ?>
<?php do_action('brunn_select_action_before_main_content'); ?>
	<div class="<?php echo esc_attr( $qodef_search_holder_params['holder'] ); ?>">
		...
		<div class="<?php echo esc_attr( $qodef_search_holder_params['inner'] ); ?>">
			<?php brunn_select_get_search_page(); ?>
		</div>
