<?php
$qodef_sidebar_layout  = brunn_select_sidebar_layout();
$qodef_grid_space_meta = brunn_select_get_meta_field_intersect( 'page_grid_space' );
...
<div class="qodef-container qodef-default-page-template">
	...
	<div class="qodef-container-inner clearfix">
        <?php do_action( 'brunn_select_action_after_container_inner_open' ); ?>
			...
			<div class="qodef-grid-row <?php echo esc_attr( $qodef_holder_classes ); ?>">
				<div <?php echo brunn_select_get_content_sidebar_class(); ?>>
					<?php
						...
						the_content();
						do_action( 'brunn_select_action_page_after_content' );
					?>
				</div>
		...
		<?php endwhile; endif; ?>
        <?php do_action( 'brunn_select_action_before_container_inner_close' ); ?>
	</div>
