<?php
$masonry_classes   = '';
$number_of_columns = brunn_select_get_meta_field_intersect( 'portfolio_single_masonry_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$masonry_classes .= ' qodef-' . $number_of_columns . '-columns';
}
$space_between_items = brunn_select_get_meta_field_intersect( 'portfolio_single_masonry_space_between_items' );
	...
	<div class="qodef-grid-col-8">
		<div class="qodef-ps-image-holder qodef-grid-list qodef-grid-masonry-list qodef-fixed-masonry-items <?php echo esc_attr($masonry_classes); ?>">
			<div class="qodef-ps-image-inner qodef-outer-space qodef-masonry-list-wrapper">
				...
				<?php
				$media = brunn_core_get_portfolio_single_media(true);
