...
namespace BrunnCore\CPT\Shortcodes\PortfolioCategoryList;
...
class PortfolioCategoryList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio Category List', 'brunn-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'value'       => array_flip( brunn_select_get_number_of_columns_array( true, array( 'one' ) ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Items Per Page', 'brunn-core' ),
