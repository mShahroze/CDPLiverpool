	...
	<div class="qodef-pcl-inner qodef-outer-space clearfix">
		<?php
			if ( ! empty( $query_results ) ) {
				foreach ( $query_results as $query ) {
					...
					<article class="qodef-pcl-item qodef-item-space">
						<div class="qodef-pcl-item-inner">
							<?php echo brunn_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/image', '', $params ); ?>
							<div class="qodef-pcli-text-holder">
								<div class="qodef-pcli-text-wrapper">
									<div class="qodef-pcli-text">
										<?php echo brunn_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/title', '', $params ); ?>
										<?php echo brunn_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/excerpt', '', $params ); ?>
									</div>
								</div>
							</div>
				...
				echo brunn_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'parts/posts-not-found', '', $params );
			}
		?>
	</div>
</div>