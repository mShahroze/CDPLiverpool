...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'brunn-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'brunn-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'brunn-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'brunn-core' )  => 'one-column',
								esc_html__( '2 Columns', 'brunn-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'brunn-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'brunn-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'brunn-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'brunn-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'brunn-core' ),
							'value'      => array( 'Make Items Float Left?' => 'yes' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'switch_to_one_column',
							'heading'     => esc_html__( 'Switch to One Column', 'brunn-core' ),
							'value'       => array(
								esc_html__( 'Default', 'brunn-core' )      => '',
								esc_html__( 'Below 1366px', 'brunn-core' ) => '1366',
								esc_html__( 'Below 1024px', 'brunn-core' ) => '1024',
								esc_html__( 'Below 768px', 'brunn-core' )  => '768',
								esc_html__( 'Below 680px', 'brunn-core' )  => '680',
								esc_html__( 'Below 480px', 'brunn-core' )  => '480',
								esc_html__( 'Never', 'brunn-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'brunn-core' ),
							'value'       => array(
								esc_html__( 'Default', 'brunn-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'brunn-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . brunn_select_get_class_attribute( $holder_classes ) . ' ' . brunn_select_get_inline_attr( $holder_styles, 'style' ) . '>';
