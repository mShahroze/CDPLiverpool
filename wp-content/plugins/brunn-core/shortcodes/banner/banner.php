<?php
namespace BrunnCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'brunn-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'brunn-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'brunn-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'brunn-core' )   => 'qodef-visible-on-hover',
								esc_html__( 'Visible on Default', 'brunn-core' ) => 'qodef-visible-on-default',
								esc_html__( 'Disabled', 'brunn-core' )           => 'qodef-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'brunn-core' ),
							'value'       => array(
								esc_html__( 'Default', 'brunn-core' )  => 'default',
								esc_html__( 'Centered', 'brunn-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'brunn-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subtitle', 'brunn-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subtitle Tag', 'brunn-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'brunn-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'brunn-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'brunn-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'brunn-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
