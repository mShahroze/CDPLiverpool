<?php
namespace BrunnCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'brunn-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'brunn-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'brunn-core' ),
							'value'      => array(
								esc_html__( '80/20', 'brunn-core' ) => '80',
								esc_html__( '75/25', 'brunn-core' ) => '75',
								esc_html__( '66/33', 'brunn-core' ) => '66',
								esc_html__( '50/50', 'brunn-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Text', 'brunn-core' ),
							'value'       => esc_html__( 'Button Text', 'brunn-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'button_top_margin',
							'heading'    => esc_html__( 'Button Top Margin (px)', 'brunn-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'brunn-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'brunn-core' )   => 'solid',
								esc_html__( 'Outline', 'brunn-core' ) => 'outline'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'brunn-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link', 'brunn-core' ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'button_target',
							'heading'    => esc_html__( 'Button Link Target', 'brunn-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'brunn-core' ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'brunn-core' ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'brunn-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'brunn-core' ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'brunn-core' ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'brunn-core' ),
							'group'      => esc_html__( 'Button Style', 'brunn-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'brunn-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'brunn-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
