...
<div class="qodef-video-button-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php if(!empty($play_button_image)) { ?>
		<a class="qodef-video-button-play-image <?php echo esc_attr($link_class); ?>" href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			...
			<?php if(!empty($play_button_text)) { ?>
				<span class="qodef-video-button-text"><?php echo esc_attr($play_button_text); ?></span>
			<?php } ?>
		</a>
	<?php } else { ?>
		<div class="qodef-video-button-play" <?php echo brunn_select_get_inline_style($play_button_styles); ?>>
			<span class="qodef-video-button-play-inner">
                <a class="qodef-video-button-icon-holder" href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
