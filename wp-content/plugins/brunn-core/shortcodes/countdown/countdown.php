<?php
namespace BrunnCore\CPT\Shortcodes\Countdown;
...
class Countdown implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Countdown', 'brunn-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Light', 'brunn-core' )   => 'qodef-light-skin',
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'year',
							'heading'     => esc_html__( 'Year', 'brunn-core' ),
							'value'       => array(
								'2018' => '2018',
								'2019' => '2019',
								'2020' => '2020',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'month',
							'heading'     => esc_html__( 'Month', 'brunn-core' ),
							'value'       => array(
								esc_html__( 'January', 'brunn-core' )   => '1',
								esc_html__( 'February', 'brunn-core' )  => '2',
								esc_html__( 'March', 'brunn-core' )     => '3',
								esc_html__( 'April', 'brunn-core' )     => '4',
								esc_html__( 'May', 'brunn-core' )       => '5',
								esc_html__( 'June', 'brunn-core' )      => '6',
								esc_html__( 'July', 'brunn-core' )      => '7',
								esc_html__( 'August', 'brunn-core' )    => '8',
								esc_html__( 'September', 'brunn-core' ) => '9',
								esc_html__( 'October', 'brunn-core' )   => '10',
								esc_html__( 'November', 'brunn-core' )  => '11',
								esc_html__( 'December', 'brunn-core' )  => '12'
							),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'day',
							'heading'     => esc_html__( 'Day', 'brunn-core' ),
							'value'       => array(
								'1'  => '1',
								'2'  => '2',
								'3'  => '3',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hour',
							'heading'     => esc_html__( 'Hour', 'brunn-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'minute',
							'heading'     => esc_html__( 'Minute', 'brunn-core' ),
							'value'       => array(
								'0'  => '0',
								'1'  => '1',
								'2'  => '2',
						...
						array(
							...
							'heading'    => esc_html__( 'Month Label', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'day_label',
							'heading'    => esc_html__( 'Day Label', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'hour_label',
							'heading'    => esc_html__( 'Hour Label', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'minute_label',
							'heading'    => esc_html__( 'Minute Label', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'second_label',
							'heading'    => esc_html__( 'Second Label', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit_font_size',
							'heading'    => esc_html__( 'Digit Font Size (px)', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'label_font_size',
							'heading'    => esc_html__( 'Label Font Size (px)', 'brunn-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/countdown', 'countdown', '', $params );
