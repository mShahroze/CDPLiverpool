<?php
namespace BrunnCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar', 'brunn-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'percent',
							'heading'    => esc_html__( 'Percentage', 'brunn-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'percentage_type',
							'heading'    => esc_html__( 'Percentage Type', 'brunn-core' ),
							'value'      => array(
								esc_html__( 'Default', 'brunn-core' )  => '',
								esc_html__( 'Floating', 'brunn-core' ) => 'floating'
							),
						...
						array(
							...
							'value'       => array_flip( brunn_select_get_title_tag( true, array(
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'brunn-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
