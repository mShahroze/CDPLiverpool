<?php
namespace BrunnCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Single Image', 'brunn-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Moving on Hover', 'brunn-core' )  => 'moving'
							)
						),
						array(
							'type'       => 'textfield',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_text_box',
							'heading'     => esc_html__( 'Enable Text Box', 'brunn-core' ),
							'value'       => array_flip( brunn_select_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'big_text',
							'heading'    => esc_html__( 'Big Text', 'brunn-core' ),
							'dependency' => Array( 'element' => 'enable_text_box', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'small_text',
							'heading'    => esc_html__( 'Small Text', 'brunn-core' ),
							'dependency' => Array( 'element' => 'enable_text_box', 'value' => array( 'yes' ) )
						),
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
