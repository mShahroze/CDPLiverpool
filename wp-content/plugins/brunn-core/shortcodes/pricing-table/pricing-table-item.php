<?php
namespace BrunnCore\CPT\Shortcodes\PricingTable;
...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Pricing Table Item', 'brunn-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Set Item As Active', 'brunn-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'brunn-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
							'heading'     => esc_html__( 'Title', 'brunn-core' ),
							'value'       => esc_html__( 'Basic Plan', 'brunn-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Title Bottom Border Color', 'brunn-core' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'price',
							'heading'    => esc_html__( 'Price', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_color',
							'heading'    => esc_html__( 'Price Color', 'brunn-core' ),
							'dependency' => array( 'element' => 'price', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'currency',
							'heading'     => esc_html__( 'Currency', 'brunn-core' ),
							'description' => esc_html__( 'Default mark is $', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'currency_color',
							'heading'    => esc_html__( 'Currency Color', 'brunn-core' ),
							'dependency' => array( 'element' => 'currency', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'price_period',
							'heading'     => esc_html__( 'Price Period', 'brunn-core' ),
							'description' => esc_html__( 'Default label is monthly', 'brunn-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_period_color',
							'heading'    => esc_html__( 'Price Period Color', 'brunn-core' ),
						...
						array(
							...
							'value'       => esc_html__( 'BUY NOW', 'brunn-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/pricing-table-template', 'pricing-table', '', $params );
