<?php
namespace BrunnCore\CPT\Shortcodes\Separator;
...
class Separator implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Separator', 'brunn-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Full Width', 'brunn-core' ) => 'full-width'
							)
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Dashed', 'brunn-core' )  => 'dashed',
								esc_html__( 'Solid', 'brunn-core' )   => 'solid',
								esc_html__( 'Dotted', 'brunn-core' )  => 'dotted'
							),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'width',
							'heading'    => esc_html__( 'Width (px or %)', 'brunn-core' ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'normal' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'thickness',
							'heading'    => esc_html__( 'Thickness (px)', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'top_margin',
							'heading'    => esc_html__( 'Top Margin (px or %)', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'bottom_margin',
							'heading'    => esc_html__( 'Bottom Margin (px or %)', 'brunn-core' )
						)
					)
				)
			);
