<?php
namespace BrunnCore\CPT\Shortcodes\FrameSlider;
...
class FrameSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Frame Slider', 'brunn-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'brunn-core' ),
							'description' => esc_html__( 'Select images from media library', 'brunn-core' )
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'brunn-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/frame-slider', 'frame-slider', '', $params );
