<?php
namespace BrunnCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'brunn-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'      => array(
									...
									esc_html__( 'Huge', 'brunn-core' )    => 'huge'
								),
						...
						brunn_select_icon_collections()->getVCParamsArray( array(), '', true ),
						array(
							array(
								'type'       => 'colorpicker',
								'param_name' => 'color',
								'heading'    => esc_html__( 'Color', 'brunn-core' ),
								'group'      => esc_html__( 'Design Options', 'brunn-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'brunn-core' ),
								'group'      => esc_html__( 'Design Options', 'brunn-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'brunn-core' ),
								'group'      => esc_html__( 'Design Options', 'brunn-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'brunn-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return brunn_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
