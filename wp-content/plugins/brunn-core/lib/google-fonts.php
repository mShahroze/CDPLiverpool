<?php
if ( ! function_exists( 'brunn_select_init_google_fonts_array' ) ) {
    function brunn_select_init_google_fonts_array() {
        ...
        $brunn_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'brunn_select_init_google_fonts_array');
}