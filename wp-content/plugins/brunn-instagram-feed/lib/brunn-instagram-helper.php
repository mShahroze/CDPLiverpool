...
/**
 * Class BrunnInstagramHelper
 */
class BrunnInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines brunn_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'brunn_instagram_image_atts',
			array(
				'class'  => $imageSize,
