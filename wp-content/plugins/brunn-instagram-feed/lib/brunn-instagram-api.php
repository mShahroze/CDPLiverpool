...
include 'brunn-instagram-helper.php';

/**
 * Class BrunnInstagramApi
 */
class BrunnInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var BrunnInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var BrunnInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'brunn_instagram_code';
	const USER_ID_OPTION_NAME = 'brunn_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'brunn_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'brunn_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new BrunnInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see BrunnInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see BrunnInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see BrunnInstagramApi::getAccessToken()
	 */
